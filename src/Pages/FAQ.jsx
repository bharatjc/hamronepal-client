  ...
  return (
    <div>
      ...
      <div className="h-[200px] bg-[#289627] opacity-75 bg-cover md:px-[60px] px-[20px] flex flex-col justify-center items-center gap-3">
        <h1 className="text-[24px] md:text-[32px] font-bold text-[#FFFFFF]">
          FAQ's
        </h1>
      ...
      <div className="md:px-[60px] px-[18px]">
        <div className="md:mx-[10vw] bg-[#F7F7F7] rounded-md my-10 py-10">
          <div className="border-b-[2px] px-10 py-5 flex flex-col gap-y-4">
            ...
            {answer === 1 && (
              <p className="bg-[#FFFFFF] px-2">
                ...
                registration must be done at the local level Filled the
                prescribed application form Residing and doing business within
                the work area of the organization.
              </p>
            )}
          </div>
          ...
          <div className="border-b-[2px] px-10 py-5 flex flex-col gap-y-4">
            ...
            >
              How much does it cost to become a share member?
            </h1>
            {answer === 2 && (
              <p className="bg-[#FFFFFF] px-2">
          ...
          <div className="border-b-[2px] px-10 py-5 flex flex-col gap-y-4">
            ...
            >
              What are the areas of the work of the organization?
            </h1>
            {answer === 3 && (
              <p className="bg-[#FFFFFF] px-2">
                Click this link:
                <span>
                  {" "}
                  http://webpromotionnepal.com/ hamronepal/ branch-network/
                </span>
              </p>
            )}
          </div>
          ...
          <div className="border-b-[2px] px-10 py-5 flex flex-col gap-y-4">
            ...
            >
              Where is the head office of the organization?
            </h1>
            {answer === 5 && (
              <p className="bg-[#FFFFFF] px-2">
                Click the link :
                <span>
                  {" "}
                  http://webpromotionnepal.com/ hamronepal/contact-us/
                </span>
              </p>
            )}
          </div>
          ...
          <div className="border-b-[2px] px-10 py-5 flex flex-col gap-y-4">
            ...
            {answer === 6 && (
              <p className="bg-[#FFFFFF] px-2">Shravan 14, 2069</p>
            )}
          </div>
          ...
          <div className="border-b-[2px] px-10 py-5 flex flex-col gap-y-4">
            ...
            >
              Who was the board of directors of the organization?
            </h1>
            {answer === 7 && (
              <p className="bg-[#FFFFFF] px-2">
                Click the link :
                <span>
                  {" "}
                  http://webpromotionnepal.com/
                  hamronepal/team-type/board-of-directors/
                </span>
              </p>
            )}
          </div>
          ...
          <div className="border-b-[2px] px-10 py-5 flex flex-col gap-y-4">
            ...
            {answer === 8 && (
              <p className="bg-[#FFFFFF] px-2">
                You can get information by contacting the service center where
          ...
          <div className="px-10 py-5 flex flex-col gap-y-4">
            ...
            >
              What is the latest financial condition of the organization?
            </h1>
            {answer === 9 && (
              <p className="bg-[#FFFFFF] w-full">
                Click the link below:
                <span> http://webpromotionnepal.com/ hamronepal/about-us/</span>
              </p>
            )}
          </div>
        </div>
