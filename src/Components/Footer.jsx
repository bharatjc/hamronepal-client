...
function Footer() {
  return (
    <div className='h-[348px] w-full'>
      <div className='h-[280px] bg-[#00A551] px-[77px] py-[24px] flex justify-between'>
        <div className='text-white mt-[16px]'>
          ...
          <ul className='gap-4 flex flex-col mt-[16px] text-[14px] font-semibold'>
            <li className='flex items-center gap-2'><HiMapPin className='text-2xl'/>Birtamode 04, Jhapa</li>
            <li className='flex items-center gap-2'><FaPhone className='text-2xl'/>023-535355</li>
            <li className='flex items-center gap-2'><HiOutlineMail className='text-2xl'/>hamronepalcoop@gmail.com</li>
          </ul>
        </div>
      ...
      <div className='h-[68px] flex flex-col justify-between items-center'>
        ...
        <div className='h-[28px] text-[13px]'>
