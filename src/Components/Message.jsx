...
function Message() {
  return (
    <div class="bg-[url('../msg-background.jpg')] px-[77px] py-[50px] my-[20px] flex justify-between items-center">
     <div className='h-[540px] w-[350px] bg-[#008C44] rounded-lg px-[22px] py-[30px] text-white'>
    ...
    <div className='flex mt-8 gap-4'>
     ...
     <div className='py-[10px] w-[720px] h-[540px]'>
      ...
      <button className='bg-[#C6621E] text-white my-10 w-[165px] h-[48px] italic rounded-3xl'>Read More</button>
     </div>
    </div>
  )
}
