...
function Message() {
  return (
    <div className="bg-[url('../msg-background.jpg')] px-[18px] md:px-[50px] py-[50px] my-[20px] flex gap-x-4 flex-col md:flex-row justify-around items-center">
    ...
    <div className='flex mt-8 gap-4'>
     ...
     <div className='py-[10px] md:w-[720px] shadow-md px-4 rounded-md'>
      ...
      <button className='hover:bg-[#C6621E] bg-[#E27429]  text-white my-4 w-[165px] h-[48px] italic rounded-3xl'><Link to="/welcome">Read More</Link></button>
     </div>
    </div>
  )
}
