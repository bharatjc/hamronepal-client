...
function Scheme() {
  return (
    <div className="bg-[url('../scheme-bg.jpg')] px-[18px] md:px-[50px] py-[50px] my-[20px] bg-cover">
      ...
      <div className='h-[288px] w-full md:w-[255px] bg-white rounded-xl shadow-lg flex flex-col justify-center items-center gap-5'>
        ...
        <button className='hover:bg-[#9B4479] delay-[200ms] transition-colors duration-300 hover:text-white italic h-[48px] w-[150px] border-[#9B4479] border-2 rounded-full text-[#6F6F6F]'>Read More</button>
      </div>
