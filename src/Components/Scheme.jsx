...
function Scheme() {
  return (
    <div class="bg-[url('../scheme-bg.jpg')] px-[77px] py-[50px] my-[20px] bg-cover">
      <div className='flex gap-5 items-center'>
      <h1 className='text-[#008C44] italic'>Schemes</h1>
      <p className='h-[0.5px] w-20 bg-[#008C44]'></p>
      </div>
      
      <h1 className='my-5 text-[35px] text-[#008C44]'><span className='text-[#474747] font-bold'>Our</span> Schemes</h1>

      <div className='flex justify-between items-center my-5'>

      <div className='h-[288px] w-[255px] bg-white rounded-xl shadow-lg flex flex-col justify-center items-center gap-5'>
